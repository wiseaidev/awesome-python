...
### 1.12 Security <a name="security"></a>

#### 🔝 [Go To TOC](#TOC).

|                               Thumbnail                                |                                       Video Title                                       |           YT Links            |    Duration    |      Speaker Deck      |  Backup files  |
| :--------------------------------------------------------------------: | :-------------------------------------------------------------------------------------: | :---------------------------: | :------------: | :--------------------: | :------------: |
| <img src="https://img.youtube.com/vi/LgoGcr8xUiI/0.jpg" width="60px"/> |                      Practical API Security. <a name="1.12.1"></a>                      | [`2019`][1110] [`2018`][1111] |   `03:18:36`   | [`Github Repo`][10102] |      ---       |
|                                 :---:                                  |                                          :---:                                          |        :------------:         | :------------: |     :------------:     | :------------: |
...
[1110]: https://www.youtube.com/watch?v=LgoGcr8xUiI
[1111]: https://www.youtube.com/watch?v=wXnvEzw4hHI
